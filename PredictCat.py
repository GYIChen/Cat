# -*- coding: utf-8 -*-
"""
Created on Sun Apr 29 11:04:13 2018
...
TestDir = 'D:/Cat1.1/Hei/'
TempDir = 'D:/Cat1.1/Temp/'
ModelDir = 'D:/Cat1.1/model1.h5'
...
def PredictCat(picname):
    ...
    model = load_model('D:/Cat1.1/Model.h5')
